...
function useTemplateA11y(config = {}) {
  ...
  const isHighContrast = vue.ref(config.highContrast || false);
  const isReducedMotion = vue.ref(config.reducedMotion || false);
  const isScreenReaderMode = vue.ref(config.screenReaderMode || false);
  ...
  vue.watch([isHighContrast, isReducedMotion, isScreenReaderMode], () => {
    applyA11yStyles();
  });
  vue.onMounted(() => {
    if (config.announceChanges) {
  ...
  return {
    ...
    announce,
    focus,
    isHighContrast: vue.computed(() => isHighContrast.value),
    isReducedMotion: vue.computed(() => isReducedMotion.value),
    isScreenReaderMode: vue.computed(() => isScreenReaderMode.value),
    toggleHighContrast: () => {
...
exports.createA11yStyles = createA11yStyles;
exports.useTemplateA11y = useTemplateA11y;
/*! End of @ldesign/template | Powered by @ldesign/builder */
//# sourceMappingURL=useTemplateA11y.cjs.map
