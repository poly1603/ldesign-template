...
function useTemplateEventBus(isolated = false) {
  const injectedBus = vue.inject(EventBusKey, null);
...
function useTemplateEvent(event, handler, options) {
  ...
  const unsubscribe = vue.ref(null);
  if (handler) {
...
exports.MiddlewareEventBus = MiddlewareEventBus;
exports.TEMPLATE_EVENTS = TEMPLATE_EVENTS;
exports.createMiddlewareEventBus = createMiddlewareEventBus;
exports.provideTemplateEventBus = provideTemplateEventBus;
exports.templateEventBus = templateEventBus;
exports.useTemplateEvent = useTemplateEvent;
exports.useTemplateEventBus = useTemplateEventBus;
exports.useTemplateEvents = useTemplateEvents;
/*! End of @ldesign/template | Powered by @ldesign/builder */
//# sourceMappingURL=useTemplateEventBus.cjs.map
