  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [vue.createElementVNode("div", _hoisted_2, [vue.createCommentVNode(" Logo \u63D2\u69FD "), _ctx.$slots.logo || _ctx.showLogo ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3, [vue.renderSlot(_ctx.$slots, "logo", {}, () => [_cache[3] || (_cache[3] = vue.createElementVNode(
        ...
        [vue.createElementVNode("div", _hoisted_6, [vue.createElementVNode("div", _hoisted_7, [vue.withDirectives(vue.createElementVNode(
          "input",
          {
          ...
          512
          /* NEED_PATCH */
        ), [[vue.vModelText, form.username]])])]), vue.createElementVNode("div", _hoisted_8, [vue.createElementVNode("div", _hoisted_9, [vue.withDirectives(vue.createElementVNode(
          "input",
          {
          ...
          512
          /* NEED_PATCH */
        ), [[vue.vModelText, form.password]])])]), _ctx.showRememberMe ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_10, [vue.createElementVNode("label", _hoisted_11, [vue.withDirectives(vue.createElementVNode(
          "input",
          {
          ...
          512
          /* NEED_PATCH */
        ), [[vue.vModelCheckbox, form.rememberMe]]), _cache[4] || (_cache[4] = vue.createElementVNode(
          "span",
          null,
          "\u8BB0\u4F4F\u6211",
          -1
        ...
        }, vue.toDisplayString(loading.value ? "\u767B\u5F55\u4E2D..." : "\u767B\u5F55"), 9, _hoisted_12)],
        32
        /* NEED_HYDRATION */
      )]), vue.createCommentVNode(" \u793E\u4EA4\u767B\u5F55\u63D2\u69FD "), _ctx.$slots.socialLogin || _ctx.showSocialLogin ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_13, [vue.renderSlot(_ctx.$slots, "socialLogin", {
        ...
        [vue.createElementVNode("span", null, "\u5176\u4ED6\u65B9\u5F0F")],
        -1
        /* CACHED */
      )), vue.createElementVNode("div", _hoisted_14, [(vue.openBlock(true), vue.createElementBlock(
        vue.Fragment,
        null,
        vue.renderList(_ctx.socialProviders, (provider) => {
          return vue.openBlock(), vue.createElementBlock("button", {
            ...
            "span",
            null,
            vue.toDisplayString(provider.label),
            1
            /* TEXT */
          )], 8, _hoisted_15);
        }),
        128
        /* KEYED_FRAGMENT */
      ))])])])) : vue.createCommentVNode("v-if", true), vue.createCommentVNode(" \u5E95\u90E8\u63D2\u69FD "), vue.createElementVNode("div", _hoisted_16, [vue.renderSlot(_ctx.$slots, "footer", {}, () => [vue.createElementVNode("a", {
        href: "#",
        onClick: vue.withModifiers(handleRegister, ["prevent"])
      }, "\u6CE8\u518C\u8D26\u53F7"), _cache[6] || (_cache[6] = vue.createElementVNode(
        "span",
        {
          class: "divider"
        },
