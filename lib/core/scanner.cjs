...
class TemplateScanner {
  ...
  async scan() {
    ...
    this.configModules = undefined("../templates/**/config.{ts,js}", {
      eager: true
    });
    this.componentModules = {
      ...undefined("../templates/**/index.vue"),
      ...undefined("../templates/**/index.vue.js")
    };
...
exports.TemplateScanner = TemplateScanner;
exports.getScanner = getScanner;
exports.scanTemplates = scanTemplates;
