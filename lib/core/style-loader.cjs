  ...
  if (componentPath && componentPath.endsWith(".vue.js")) {
    ...
    try {
      ...
      if (stylePath.startsWith("../")) {
        const baseUrl = new URL((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('core/style-loader.cjs', document.baseURI).href)));
...
exports.cleanupUnusedStyles = cleanupUnusedStyles;
exports.clearLoadedStyles = clearLoadedStyles;
exports.loadComponentStyle = loadComponentStyle;
exports.loadGlobalStyles = loadGlobalStyles;
exports.loadStyles = loadStyles;
exports.removeStyle = removeStyle;
/*! End of @ldesign/template | Powered by @ldesign/builder */
//# sourceMappingURL=style-loader.cjs.map
