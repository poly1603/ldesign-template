...
function useTypedTemplate(template) {
  ...
  const computedTemplate = vue.computed(() => "value" in templateRef.value ? templateRef.value.value : templateRef.value);
  const props = vue.computed(() => computedTemplate.value.props);
  const events = vue.computed(() => computedTemplate.value.events);
  const slots = vue.computed(() => computedTemplate.value.slots);
...
exports.TemplateTypeRegistry = TemplateTypeRegistry;
exports.TypeGenerator = TypeGenerator;
exports.TypeGuard = TypeGuard;
exports.TypeMapper = TypeMapper;
exports.TypeValidator = TypeValidator;
exports.createTypedTemplate = createTypedTemplate;
exports.typeGenerator = typeGenerator;
exports.typeMapper = typeMapper;
exports.typeRegistry = typeRegistry;
exports.typeValidator = typeValidator;
exports.useTypedTemplate = useTypedTemplate;
/*! End of @ldesign/template | Powered by @ldesign/builder */
//# sourceMappingURL=typeSafety.cjs.map
