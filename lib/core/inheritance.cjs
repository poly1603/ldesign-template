...
var vue = require('vue');
require('../utils/errorHandler.cjs');
...
class TemplateInheritanceManager {
  ...
  mergeConfig(parentConfig, childConfig, strategy) {
    ...
    return helpers.deepMerge(parentConfig, childConfig);
  }
  /**
   * 合并组件
   */
  mergeComponents(parentComponent, childComponent, strategy) {
    ...
    return vue.defineComponent({
      ...
      setup(props, ctx) {
        return () => vue.h(childComponent, props, ctx.slots);
      }
    });
  }
  /**
...
${childStyles}`;
  ...
  mergeData(parentData, childData, strategy) {
    ...
    return helpers.deepMerge(parentData, childData);
  }
  /**
   * 解析模板
   */
...
exports.TemplateBlockManager = TemplateBlockManager;
exports.TemplateInheritanceManager = TemplateInheritanceManager;
exports.blockManager = blockManager;
exports.createInheritableTemplate = createInheritableTemplate;
exports.createTemplateMixin = createTemplateMixin;
exports.inheritanceManager = inheritanceManager;
exports.registerBaseTemplate = registerBaseTemplate;
