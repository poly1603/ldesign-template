...
class TemplateAnalytics {
   ...
   */
  getConfig() {
    return vue.readonly(this.config);
  }
}
...
function useTemplateAnalytics(config) {
  ...
  const allUsage = vue.computed(() => analytics.getAllUsage());
  const report = vue.computed(() => analytics.generateReport());
...
exports.destroyGlobalAnalytics = destroyGlobalAnalytics;
...
//# sourceMappingURL=templateAnalytics.cjs.map
