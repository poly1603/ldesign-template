...
let TemplateManager$1 = class TemplateManager extends EventEmitter {
    ...
    async scanTemplates() {
        ...
        try {
            ...
            const templateModules = import.meta.glob(`${this.config.templateRoot}/**/index.ts`, { eager: false });
...
function useTemplate(category, config = {}) {
    ...
    // 计算当前模板配置
    const currentTemplateConfig = computed(() => currentTemplate.value ? currentTemplate.value.config : null);
    return {
...
export { CacheManager, DeviceDetector, EventEmitter, StorageManager, TemplateFilterUtils, TemplateManager$1 as TemplateManager, TemplatePathUtils, VERSION, createTemplateManager, debounce, deepClone, index as default, defaultConfig, formatFileSize, generateId, getDefaultTemplate, getGlobalTemplateManager, getTemplatesByCategory, getTemplatesByDevice, initTemplateSystem, install, setGlobalTemplateManager$1 as setGlobalTemplateManager, templateCategories, templateConfigs, throttle, useDeviceDetector, useReactiveStorage, useStorage, useTemplate, useTemplateCache, validateTemplateConfig };
