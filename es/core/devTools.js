...
class TemplateInspector {
  constructor() {
    this.selectedTemplate = ref(null);
    this.selectedComponent = ref(null);
    this.highlightEnabled = ref(false);
  }
  /**
   * 选择模板
   */
...
export { ConsoleEnhancer, DevToolsManager, NetworkMonitor, TemplateDebugger, TemplateInspector, TemplateProfiler, devTools };
