...
class TemplatePerformanceAnalyzer {
  constructor() {
    this.performanceReports = reactive([]);
...
export { TemplateAnalyzer, TemplateComplexityAnalyzer, TemplateDependencyAnalyzer, TemplatePerformanceAnalyzer, TemplateStatisticsAnalyzer, templateAnalyzer };
