  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [createElementVNode("div", _hoisted_2, [createCommentVNode(" Logo \u63D2\u69FD "), _ctx.$slots.logo || _ctx.showLogo ? (openBlock(), createElementBlock("div", _hoisted_3, [renderSlot(_ctx.$slots, "logo", {}, () => [_cache[3] || (_cache[3] = createElementVNode(
        ...
        32
        /* NEED_HYDRATION */
      )]), createCommentVNode(" \u793E\u4EA4\u767B\u5F55\u63D2\u69FD "), _ctx.$slots.socialLogin || _ctx.showSocialLogin ? (openBlock(), createElementBlock("div", _hoisted_11, [renderSlot(_ctx.$slots, "socialLogin", {
        ...
        [createElementVNode("span", null, "\u6216\u4F7F\u7528\u4EE5\u4E0B\u65B9\u5F0F\u767B\u5F55")],
        -1
        /* CACHED */
      )), createElementVNode("div", _hoisted_12, [(openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList(_ctx.socialProviders, (provider) => {
          ...
          }, toDisplayString(provider.label), 9, _hoisted_13);
        }),
        128
        /* KEYED_FRAGMENT */
      ))])])])) : createCommentVNode("v-if", true), createCommentVNode(" \u5E95\u90E8\u63D2\u69FD "), createElementVNode("div", _hoisted_14, [renderSlot(_ctx.$slots, "footer", {}, () => [createElementVNode("p", _hoisted_15, [_cache[8] || (_cache[8] = createTextVNode(
        " \u8FD8\u6CA1\u6709\u8D26\u53F7\uFF1F ",
        -1
        /* CACHED */
      )), createElementVNode("a", {
      ...
      }, "\u7ACB\u5373\u6CE8\u518C")])])]), createCommentVNode(" \u989D\u5916\u5185\u5BB9\u63D2\u69FD "), renderSlot(_ctx.$slots, "extra")])]);
    };
  }
});
