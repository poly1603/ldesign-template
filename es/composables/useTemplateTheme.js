 ...
 * ***********************************
 */
import { inject, computed, ref, readonly, provide } from 'vue';
...
function useTemplateTheme() {
  let context = inject(ThemeContextKey, void 0);
  if (!context) {
...
export { PRESET_THEMES, createThemeManager, provideTemplateTheme, useTemplateTheme };
/*! End of @ldesign/template | Powered by @ldesign/builder */
//# sourceMappingURL=useTemplateTheme.js.map
