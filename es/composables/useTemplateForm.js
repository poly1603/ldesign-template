 ...
 * ***********************************
 */
import { reactive, ref, computed, watch, onUnmounted, readonly } from 'vue';
...
function useTemplateForm(options = {}) {
  ...
  const errors = reactive(/* @__PURE__ */ new Map());
  const touched = reactive(/* @__PURE__ */ new Set());
  ...
  const stopWatching = watch(() => formData, () => {
    dirty.value = true;
  }, {
    deep: true
  });
...
export { useTemplateForm, useTemplateModel };
/*! End of @ldesign/template | Powered by @ldesign/builder */
//# sourceMappingURL=useTemplateForm.js.map
